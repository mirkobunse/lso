...
"""
    bt(obj [; c, α_0, η, maxiter])

    Returns a LineSearch strategy for Backtracking (Armijo) Line Search on given
...
"""
function bt(obj::Objective; c::Float64=1e-1, α_0::Float64=1.0, η::Float64=0.1, maxiter::Int32=10)
    return LineSearch(
        obj, # objective function

        # strategy
        function (w::Array{Float64,1}, s::Array{Float64,1}, b::Array{Int32,1}, fw::Float64, gw::Array{Float64,1})
            return _bt(obj, w, s, fw, gw, c, α_0, η, maxiter)   # b is ignored
        end
    )
end
